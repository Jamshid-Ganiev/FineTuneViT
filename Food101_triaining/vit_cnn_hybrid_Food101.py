...
class CNN_ViT(nn.Module):
    def __init__(self, num_classes=101):  # 101 classes
...
# crate model
model = CNN_ViT(num_classes=101).to(device)
...
results, best_accuracy = train_and_evaluate(
    ...
    save_path="./trained_models/best_model_cnn_vit_food101.pth", results_path="./Food101_ViT_CNN_hybrid_results.json"
)
